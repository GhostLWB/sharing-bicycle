 ...
 */
    ...
    private class ValueTouchListener implements ColumnChartOnValueSelectListener {
        ...
        public void onValueSelected(int columnIndex, int subcolumnIndex, SubcolumnValue value) {
            ...
            final Snackbar snackbar=Snackbar.make(getActivity().getWindow().getDecorView(),"您在"+valid_data.get(columnIndex).getDate_time().split(" ")[0]+"这天骑行了"+valid_data.get(columnIndex).getRidetime()+"分钟",Snackbar.LENGTH_SHORT);
