...
import com.project.liwenbin.sharing_bicycle.overlay.RideRouteOverlay;
        ...
        aMap.setLocationSource(new LocationSource() {
            ...
            public void activate(OnLocationChangedListener listener) {
                ...
                if (mlocationClient == null) {
                    //初始化定位
                    mlocationClient = new AMapLocationClient(NavigateActivity.this);
                    //初始化定位参数
        ...
        bt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if((myMarker!=null)&&(endMarker!=null)){
                    Intent intent = new Intent(NavigateActivity.this,RideRouteCalculateActivity.class);
    ...
    private void iniSearch(){
        ...
        search_edittext.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                ...
                Inputtips inputtips=new Inputtips(NavigateActivity.this,inputtipsQuery);//定义一个输入提示对象，传入当前上下文和搜索对象
                inputtips.setInputtipsListener(new Inputtips.InputtipsListener() {
                    ...
                    public void onGetInputtips(List<Tip> list, int returnCode) {
                        if(returnCode== AMapException.CODE_AMAP_SUCCESS){//如果输入提示搜索成功
                            ...
                            searchAdapter=new SearchAdapter(NavigateActivity.this,searchList,list_tip);//新建一个适配器
        ...
        search_list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                mRouteSearch = new RouteSearch(NavigateActivity.this);
                    ...
                    public void onRideRouteSearched(RideRouteResult result, int rCode) {
                        ...
                        if (rCode == AMapException.CODE_AMAP_SUCCESS) {
                            if (result != null && result.getPaths() != null
                                ...
                                RideRouteOverlay routeOverlay = new RideRouteOverlay(NavigateActivity.this, aMap,
