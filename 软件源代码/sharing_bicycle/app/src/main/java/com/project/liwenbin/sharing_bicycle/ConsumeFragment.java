 ...
 */
    ...
    private class ValueTouchListener implements ColumnChartOnValueSelectListener {
        ...
        public void onValueSelected(int columnIndex, int subcolumnIndex, SubcolumnValue value) {
            final Snackbar snackbar=Snackbar.make(getActivity().getWindow().getDecorView(),"您在"+data_raw.get(columnIndex).getDate_time()+"消费了"+data_raw.get(columnIndex).getAmount()+"元",Snackbar.LENGTH_SHORT);
