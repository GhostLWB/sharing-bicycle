...
public class GetCreditFragment extends Fragment {
    ...
    private class ValueTouchListener implements PieChartOnValueSelectListener {
        ...
        public void onValueSelected(int arcIndex, SliceValue value) {
            switch (arcIndex){
                case 0:
                    Toast.makeText(getActivity(), "这是您通过预约车辆获得的" +each_type[0]+"个积分" , Toast.LENGTH_SHORT).show();
                    break;
                case 1:
                    Toast.makeText(getActivity(), "这是您通过使用车辆获得的" +each_type[1]+"个积分" , Toast.LENGTH_SHORT).show();
                    break;
                case 2:
                    Toast.makeText(getActivity(), "这是您通过报修获得的" +each_type[2]+"个积分" , Toast.LENGTH_SHORT).show();
                    break;
            }
