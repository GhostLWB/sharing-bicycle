 ...
 * 用于返回骑行记录 客户端
 */
public class Cycling_record_servlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		//定义sql语句
		String sql ="SELECT bike_id,date_time,riding_time FROM cycling_record WHERE id=? ORDER BY date_time desc";
		try {
